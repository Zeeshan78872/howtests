                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $book->title }}" name="title" id="exampleFirstName" placeholder="Title">
                                @error('title')
                            ...
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $book->tagline }}" name="tagline" id="exampleFirstName" placeholder="Tagline">
                                @error('tagline')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row ">
                            <div class="col-sm-12">
                                ...
                                <textarea name="description" class="form-control @error('description') is-invalid @enderror" id=""
                                    cols="30" rows="4" maxlength="1000" placeholder="Description Here">{{ $book->desc }}</textarea>
                                @error('description')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $book->author }}" name="author" id="author" placeholder="Author">
                                @error('author')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-sm-6">
                                ...
                                @error('file')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>The Book image field must be an image.
                                        </strong>
                                    </span>
                                @enderror
