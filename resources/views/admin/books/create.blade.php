                    ...
                    <form class="user" action="{{ route('Book.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('title') }}" name="title" id="exampleFirstName" placeholder="Title">
                                @error('title')
                            ...
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('tagline') }}" name="tagline" id="exampleFirstName" placeholder="Tagline">
                                @error('tagline')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row ">
                            <div class="col-sm-12">
                                ...
                                <textarea name="description" class="form-control @error('description') is-invalid @enderror" id=""
                                    cols="30" rows="4" maxlength="1000" id="myTextarea" placeholder="Description Here">{{ old('description') }}</textarea>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control form-control-user" value="{{ old('meta_title') }}"
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('meta_keywords') }}" name="meta_keywords" id="meta_keywords"
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                <label for="meta_desc" class="">Meta Description</label>
                                <textarea name="meta_desc" class="form-control " id="meta_desc" cols="30" rows="3"
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('author') }}" name="author" id="author" placeholder="Author">
                                @error('author')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="number" class="form-control number-input" name="Cquestion[]"
                                    onchange="CheckValid(-1)" id="noOfQ-1"
                                    ...
                                    <div class="row form-group" id="field_{{ $old }}">
                                        ...
                                        <div class="col-sm-5">
                                            ...
                                            <input type="number"
                                                ...
                                                name="Cquestion[]" onchange="CheckValid({{ $old }})"
                                                id="noOfQ{{ $old }}" value="{{ old('Cquestion.' . $i) }}"
...
@section('script')
    ...
    <script>
        ...
        function AddField() {
            ...
            <div class="col-sm-5 mb-3 mb-sm-0">
                                <label for="totalCount${categortCount}" class="">Category (2nd name)</label>
                            ...
                            <div class="col-sm-5">
                                <label for="" class="">No of Question</label>
                                <input type="number"  class="form-control number-input" name="Cquestion[]" onchange="CheckValid(${categortCount})" id="noOfQ${categortCount}"
                                    placeholder="Choose question from category">
